...
const FileIconDisplay = ({ fileAddress, hiddenName }) => {
  ...
  return (<Tooltip title={fileName}>
    <div className="d-flex gap-2 align-items-center w-fit-content ">
      ...
      <div className="text-gray text-truncate " style={{ fontSize: '12px', width: !hiddenName ? '130px' : "auto" }}>
        {!hiddenName && fileShowName}</div>
    </div>
  </Tooltip>);
};
