...
const Carry = ({ purchaseDetail }) => {
  ...
  return (
    <div>
      ...
      {showStatus ? (
        <ShowCarry purchaseDetail={purchaseDetail} purchasePositionTitle={purchasePositionTitle}
                   changeShow={changeShow} />
      ) : (
        <EditCarry positionList={positionList} setPurchasePositionTitle={setPurchasePositionTitle}
                   changeShow={changeShow}
