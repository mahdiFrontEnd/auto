...
import { Button, Form, Modal, Switch, TreeSelect } from 'antd';
              ...
              <div onClick={showModal}>
                <div className="d-none d-md-block">
                  <IconBtn TooltipText="ارجاع" btnClass="blueIconBtn"
                           icon={<ExportSquare variant="Bold" size={22} />} />
                </div>
                <div className="d-md-none" style={{ width: '160px' }}>
                  <Button className="text-black d-flex align-items-center gap-2 px-0" type="link">
                    ...
                    <span className="blueText">
                      <ExportSquare variant="Bold" size={22} />
                    </span>
        ...
        >
          ...
          >
            ...
            <TreeSelect
              ...
              allowClear
              onChange={(e)=>{
                form.setFieldValue("refer",handleData(e))
              }}
              loading={automationUserListLoading}
              // fieldNames={{ label: 'name', value: 'id' }}
              treeData={automationUserList}
