    ...
    <>
            ...
            inDetail ?
              ...
              <div>
                <div className="d-none d-md-block ">
                  <Button className={`defBtn  min-w-100 ${buttonColor(rowData?.status_title)} fw-light`}
                          onClick={showModal}>
                    {rowData?.status_title}
                  </Button>
                </div>
                <div className="d-md-none" style={{ width: '160px' }}>
                  <Button className="text-black d-flex align-items-center gap-2 px-0" type="link">
                    ...
                    <span className="orangeText">
                                            <ProgrammingArrows variant="Bold" size={22} />
                                        </span>
      ...
      <Modal
        ...
        footer={[
          ...
          <Button key="submit" className="defBtn orangeBtn px-4" loading={loading} onClick={handleStatus}>
            ثبت
          </Button>,
