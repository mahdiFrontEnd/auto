...
const TopTableForm = () => {
  ...
  const handleEntryExit = () => {
    ...
    // let newData = statusForm.products?.filter((item) => item.selected);
    ...
    //   toast.error('لطفا ابتدا aaaaaaaaaaaaaکالاهای مدنظر خود را انتخاب کنید');
    // } else {
      handleRequest("process/form/store_form", data);
    // }
  };
