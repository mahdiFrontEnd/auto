...
const ShowDetailsOfWarehouseToWarehouseNew = ({ data }) => {
    ...
    <Collapse className="mb-4">
      <Collapse.Panel header="نمایش جزییات" key="1">
        ...
        <div className="row">
          ...
          {/*<div className="col-md-6 ">*/}
          {/*  <div className="keyValue justify-content-between mb-4">*/}
          {/*    <div className="key">محدودیت زمانی:</div>*/}
          {/*    <div className="value">*/}
          {/*      {data?.dead_time ? dayjs(data?.dead_time).format('HH:mm YYYY-MM-DD') : ''}</div>*/}
          {/*  </div>*/}
          {/*</div>*/}
          <div className="col-md-6 ">
            <div className="keyValue justify-content-between mb-4">
...
export default ShowDetailsOfWarehouseToWarehouseNew;