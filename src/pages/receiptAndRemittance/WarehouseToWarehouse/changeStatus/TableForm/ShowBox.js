...
const ShowBox = ({ index }) => {
  ...
  console.log(receiptAndRemittanceArray);
  return (
    <>
      ...
      <div className="flex-1 d-flex gap-2 justify-content-center">
        <span>{receiptAndRemittanceArray[index].old_amount}</span><span>{receiptAndRemittanceArray[index].product?.unit?.unit_value}</span>
      </div>
      {/*<div*/}
