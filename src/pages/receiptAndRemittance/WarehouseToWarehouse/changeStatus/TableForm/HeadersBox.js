...
const HeadersBox = () => {
  const { storekeeperList,receiptAndRemittanceArray } = useSelector((state) => state.Storehouse);
  ...
  return (
    ...
    >
      ...
      {storekeeperList?.length ? <div className="flex-1 text-center">انباردار</div> : ''}
