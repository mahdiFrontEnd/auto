    ...
    <div style={{ fontSize: '13px' }} className=" d-none d-sm-flex align-items-center gap-2 ">
      ...
      <div className="d-flex align-items-center gap-2 text-gray">
        <span className="fs-7">ساعت ورود:  </span>
        {
          attendance?.type ?
            <>
              <span className="orangeText fw-bold fs-4">{attendance?.time_in}</span>
            ...
            :
            <span className="text-warning ">ثبت نشده</span>
        }
          ...
          <div className="d-flex align-items-center gap-2">
            <span className="fs-7">ساعت ورود  </span>
            {
              attendance?.type ? <>
                ...
                <span className="fw-bold text-warning ">ثبت نشده</span>}
